...
:::{.callout-warning}
In order to use the google drive and git as instructed, you need to update your personal configure files for [`rclone`](gd.qmd) and [`git`](./git.qmd) on the **cluster**  first. 
:::
